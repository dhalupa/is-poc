...
/*
  ...
  Version SC_SNAPSHOT-2012-02-15_v8.1p/LGPL Development Only (2012-02-15)
...
);isc.evalBoundary;isc.B.push(isc.A.placeNear=function isc_Canvas_placeNear(_1,_2){if(isc.isAn.Array(_1)){_2=_1[1];_1=_1[0]}else if(isc.isAn.Object(_1)){_2=_1.top;_1=_1.left}
...
);isc.evalBoundary;isc.B.push(isc.A.scrollToTop=function isc_Canvas_scrollToTop(){this.scrollTo(null,0,"scrollToTop")}
...
return null}
);isc.evalBoundary;isc.B.push(isc.A.startHover=function isc_Canvas_startHover(_1){isc.Hover.setAction(this,this.$wb,null,this.hoverDelay)}
